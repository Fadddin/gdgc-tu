...
export default function Events() {
  ...
  const handlePastEvents = async () => {
    try {
      const response = await fetch(
        "https://gdg.community.dev/api/event_slim/for_chapter/2071/?status=Completed&include_cohosted_events=true&visible_on_parent_chapter_only=true&order=-start_date&fields=title,start_date,end_date,event_type_title,picture,url,description_short,venue_name"
      );
